...
public class CatServer extends JFrame{
	private static ServerSocket ss;
	JPanel jp = new JPanel();
	JButton jb = new JButton("关闭服务器");
	
	
	public CatServer(){

		this.setBounds(400, 300, 40, 80);
		jp.add(jb);
...
//						System.out.println("getClients"+bean.getClients());
						serverBean.setInfo(bean.getInfo());
//						System.out.println("getInfo"+bean.getInfo());
						serverBean.setName(bean.getName());
//						System.out.println("v"+bean.getName());
